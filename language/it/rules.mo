...
$lang['respectrules'] = 'Queste regole devono essere rispettate, ogni violazione di tali norme &egrave; verr&egrave; punita con il ban temporaneo o permanente !';
...
$lang['MultiAccountText2'] = 'Se due o pi&ugrave; giocatori condividono lo stesso indirizzo IP (membri di una stessa famiglia, coppie, scuole, ecc), non deve esistere alcun altro punto in comune tra questi account (partecipare alla stessa alleanza &egrave; tollerato),altrimenti  pu&oacuta; essere considerato come account multiplo e rischia il blocco.';
$lang['MultiAccountText3'] = 'Sone vietate tutte le iterazioni tra contatti con lo stesso IP.';

$lang['SittingText']  = 'Il sitting di un account &egrave; subordinata al rispetto delle seguenti regole:';
...
$lang['SittingText4'] = 'Il trasferimento di risorse da altri pianeti o lune nel account in sitting &egrave; severamente vietato.';
$lang['SittingText5'] = 'Prima che il conto può essere cancellato, &egrave; necessario il login per l\'account del proprietario.';
